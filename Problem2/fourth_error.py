...
#     for i in range(0,len(NUM_OF_PLANE_CALCULATE)):
#         if plane_have_port[i]!=-1:
#             port_use_plane_index[].append()
...
out_index=[ -2 for i in range(0,NUM_OF_PLANE+1)] # 初始化一个数组
for i in range(0,NUM_OF_PLANE):
...
for i in plane_have_port_best_1:
    if i==0:
        count+=1
'''
